...
public static Method getMethod(Class<?> clazz, String methodName, Class<?>... parameterTypes)
  ...
  public enum PacketType
  {
    ...
    static
    {
      ...
      PacketType[] arrayOfPacketType;
      int j = (arrayOfPacketType = values()).length;
      for (int i = 0; i < j; i++)
      {
        PacketType type = arrayOfPacketType[i];
